...
namespace Drive
{
    public partial class FormGPS
    {
        ...
        private void btnAutoSteer_Click(object sender, EventArgs e)
        {
            ...
            //turn on actual steerSwitch if in sim
            if (timerSim.Enabled)
            {
                if (isAutoSteerBtnOn) mc.steerSwitchValue = 0;
                else mc.steerSwitchValue = 1;
            }
        ...
        private void setWorkingDirectoryToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                RegistryKey regKey = Registry.CurrentUser.OpenSubKey(@"SOFTWARE\Drive",true);
        ...
        private void simulatorOnToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (simulatorOnToolStripMenuItem.Checked)
                {
                    ...
                    DialogResult result3 = MessageBox.Show(gStr.gsDriveWillExitPlzRestart, gStr.gsTurningOnSimulator ,MessageBoxButtons.OK);
                ...
                else
                {
                    ...
                    DialogResult result3 = MessageBox.Show(gStr.gsDriveWillExitPlzRestart, gStr.gsTurningOffSimulator, MessageBoxButtons.OK);
                    Settings.Default.setMenu_isSimulatorOn = simulatorOnToolStripMenuItem.Checked;
                    Settings.Default.Save();
                    Application.Restart();
                    Environment.Exit(0);
