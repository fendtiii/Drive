...
namespace Drive
{
    public partial class FormGPS
    {
        ...
        public bool isKeyboardOn = true, isSimNoisy, isLogHeading;
        ...
        private void tmrWatchdog_tick(object sender, EventArgs e)
        {
            ...
            if (ScanForNMEA())
            {
                ...
                if (displayUpdateThreeSecondCounter != threeSeconds)
                {
                    ...
                    else if (curve.isBtnCurveOn) btnCurve.Text = "# " + CurveNumber;
                    else btnCurve.Text = "";
                ...
                if (displayUpdateOneSecondCounter != oneSecond)
                {
                    ...
                    //if (isLogHeading) pn.isTimeToLogHeading = true;

                    if (mc.steerSwitchValue == 0)
                    {
                        this.btnAutoSteer.BackColor = System.Drawing.Color.LightGreen;
                    }
                    else
                    {
                ...
                lblInt.Text = ABLine.inty.ToString("N2");
                lblDelta.Text = glm.toDegrees(ABLine.abFixHeadingDelta).ToString("N2");
                lblDist.Text = glm.toDegrees(ABLine.xTrackCorrection).ToString("N2");
        ...
        private void LoadGUI()
        {
            ...
            isLogNMEA = Settings.Default.setMenu_isLogHeading;
            ...
            inoVersionInt = int.Parse(fullVers[2], CultureInfo.InvariantCulture);
            inoVersionStr = inoVersionInt.ToString();
        ...
        private void FixPanelsAndMenus()
        {
            ...
            if (!isSimple)
            {
                ...
                layoutPanelRight.SetRow(btnAutoSteer, 5);
                layoutPanelRight.SetColumn(btnAutoSteer, 0);
                layoutPanelRight.SetColumnSpan(btnAutoSteer, 2);
            ...
            if (isSimple)
            {
                ...
                snapRightBigStrip.Visible = true;
                layoutPanelRight.SetRow(btnAutoSteer, 5);
                layoutPanelRight.SetColumn(btnAutoSteer, 1);
                layoutPanelRight.SetColumnSpan(btnAutoSteer, 1);
