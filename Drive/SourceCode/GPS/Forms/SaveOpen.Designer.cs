...
namespace Drive
{
    ...
    public partial class FormGPS
    {
            ...
            using (StreamReader reader = new StreamReader(filename))
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        ast.stanleyGain = Properties.Vehicle.Default.setVehicle_stanleyGain;
                        ast.stanleyHeadingErrorGain = Properties.Vehicle.Default.setVehicle_stanleyHeadingErrorGain;
        ...
        public void FileSaveHeading()
        {
            using (StreamWriter writer = new StreamWriter((fieldsDirectory + "\\Heading_log.txt"), true))
            {
                writer.Write(pn.logHeading.ToString());
            }
            pn.logHeading.Clear();
        }
